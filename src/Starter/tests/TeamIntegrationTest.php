...
class TeamIntegrationTest extends TestCase
{
    ...
    {
        $response = $this->actor->call('GET', 'admin/teams');
    ...
    {
        $response = $this->actor->call('GET', 'admin/teams/create');
        $this->assertEquals(200, $response->getStatusCode());
    }
    ...
    public function testStore()
    {
        ...
        $response = $this->actingAs($admin)->call('POST', 'admin/teams', $this->team->toArray());

        $this->assertEquals(302, $response->getStatusCode());
        $this->assertRedirectedTo('admin/teams/'.$this->team->id.'/edit');
    }
    ...
    public function testEdit()
    {
        ...
        $this->actingAs($admin)->call('POST', 'admin/teams', $this->team->toArray());

        $response = $this->actingAs($admin)->call('GET', '/admin/teams/'.$this->team->id.'/edit');
        $this->assertEquals(200, $response->getStatusCode());
    ...
    public function testUpdate()
    {
        ...
        $response = $this->actingAs($admin)->call('PATCH', 'admin/teams/1', $this->teamEdited->toArray());
    ...
    public function testDelete()
    {
        ...
        $response = $this->actingAs($admin)->call('DELETE', '/admin/teams/'.$team->id);
        $this->assertEquals(302, $response->getStatusCode());
