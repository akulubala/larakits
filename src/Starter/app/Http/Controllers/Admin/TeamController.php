...
class TeamController extends Controller
{
    ...
    public function store(TeamRequest $request)
    {
        ...
        if ($result) {
            return redirect('admin/teams/'.$result->id.'/edit')->with('message', 'Successfully created');
        }

        return redirect('admin/teams')->with('message', 'Failed to create');
    }
    ...
    public function destroy($id)
    {
        ...
        if ($result) {
            return redirect('admin/teams')->with('message', 'Successfully deleted');
        }

        return redirect('admin/teams')->with('message', 'Failed to delete');
    }
