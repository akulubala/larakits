    ...
    <div class="row">
        ...
        <div class="col-md-6 raw-margin-bottom-24">
            @if (Auth::user()->isTeamAdmin($team->id))
                    {!! Form::model($team, ['url' => 'admin/teams/'.$team->id.'/invite', 'method' => 'post']) !!}
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if (! $member->isTeamAdmin($team->id))
                                            <a class="btn btn-danger pull-right btn-xs" href="{{ url('admin/teams/'.$team->id.'/remove/'.$member->id) }}" onclick="return confirm('Are you sure you want to remove this member?')">Remove</a>
                                        @endif
                                    </td>
                                </tr>
                            @endforeach
