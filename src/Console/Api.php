...
class Api extends Command
{
     ...
     * @var string
     */
    protected $signature = 'larakits:api';
     ...
     * @var string
     */
    protected $description = 'Larakits will add JWT API access to your app';
    ...
    public function handle()
    {
        if (! file_exists(base_path('resources/views/team/create.blade.php'))) {
            ...
            if ($result) {
                ...
                $this->info("You cancelled the Larakits api");
            }
        }
    }
}
